...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["212617486161"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["212617486161"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["212617486161"];
global.OwnerName = process.env.OWNER_NAME || "NOXY";
